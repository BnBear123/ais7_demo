...
snb, ax = plt.subplots(figsize=(10, 3))
sns.barplot(data=data, x='origin', y='mpg', hue='cylinders', estimator=sum)
st.pyplot(snb)

# snc, ax = plt.subplots(figsize=(10, 3))
# sns.catplot(data=data, x='origin', y='mpg', kind='box', col='cylinders', col_wrap=3)
# st.pyplot(snc)
